// This file is not completed yet - it should use both insert-list and insert-map to construct a list-based versioning system.
...
// // Rather than just an [index, agentId], it's a path of [index, agentId]
